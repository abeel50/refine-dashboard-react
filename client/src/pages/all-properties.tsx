        ...
        <Box>
                ...
                <Stack direction="column" width="100%">
                    ...
                    <Box mb={2} mt={3} display="flex" width="84%" justifyContent="space-between" flexWrap="wrap" >
                        <Box display="flex" gap={2} flexWrap="wrap" mb={{ xs: '20px', sm: 0 }}>
                            ...
                            <Select variant='outlined' color='info' required displayEmpty
                                inputProps={{ 'aria-label': 'Without label' }} defaultValue=""
            ...
            <Box mt="20px" sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
                {allProperties.map((property) => (
                    <PropertyCard key={property._id} id={property._id} title={property.title}
                        price={property.price} location={property.location} photo={property.photo} />
